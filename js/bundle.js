...
var templateSource = document.getElementById('about-template').innerHTML, 
	template = Handlebars.compile(templateSource),
	resultsPlaceholder = document.getElementById('about');
...
document.getElementById('search').addEventListener('keypress', function(e) {
	...
	if(key === 13) {
		e.preventDefault();
		console.log(s.searchArtists(document.getElementById('query').value));

		// findSimilar(target.getAttribute('data-artist-id'), function(data) {
		// 	console.log(target.getAttribute('data-artist-id'));
		// });
...
// 	$.ajax({
// 		url:
// 		'https://api.spotify.com/v1/artist',
// 		data: {
// 			q: query,
// 			type: 'artist'
// 		},
...
// var findSimilar = function(artistId, query) {
// 	$.ajax({
// 		url:
...
// function getPopularity(artist) {

// }

// function getDancibility(artist) {
